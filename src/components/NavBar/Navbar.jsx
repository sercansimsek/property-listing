...
export const Navbar = () => {
	return (
		<div className="max-w-[329px] max-h-[306px] bg-[#20293A] bg-opacity-95 rounded-md px-10 py-8 font-['DM Sans']">
			<div className="grid grid-cols-2 gap-3 justify-center items-center text-sm text-[#F2F9FE] cursor-pointer mb-6">
			...
			<div className="flex flex-col gap-5">
				...
				<div className="h-[48px] py-3 px-6 border-2 rounded-xl border-[#4A5567] flex gap-3">
